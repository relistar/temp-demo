                ...
                <div className="container">
                    <div className="intro">
                        <div className="page-header">
                            ...
                            <div className="empty empty--third empty--circle-top">
                                <svg width="100%" height="124" viewBox="0 0 275 124" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M274 0C274 67.931 212.887 123 137.5 123C62.1131 123 1 67.931 1 0" stroke="#DCE8FF"/>
                                </svg>
                            </div>
                    ...
                    <div className="constructor-cards">
                        <div className="constructor-card constructor-card--first">
                            ...
                            <div className="constructor-card__desc">Ответьте на ряд вопросов и мы поможем Вам sвыбрать готовое решение</div>
                            <Link href="/card">
